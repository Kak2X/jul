...
CREATE TABLE `delusers` (
  ...
  `postheader` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `css` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signature` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sidebartype` tinyint(4) unsigned NOT NULL DEFAULT '0',
  `sidebar` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `forums` (
  ...
  `specialtitle` tinytext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `misc` (
  ...
  `maxuserstext` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
