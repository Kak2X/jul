<?php
	...
	$numfil='numxmas';
	//  $config['board-title']='<img src=xkeeper/img/pointlessbannerv2-1a.gif width=600 height=100 title="FORCED SCHEMEEEEEEE">';
	$formcss=1;
	$inputborder='8090C0';
	$bgcolor='020335';
...
#	$linkcolor2='FFA090';
	...
	$config['board-title']='<img src="images/christmasbanner-cpubasic.png" width=600 height=100 title="Looks like Sakura is taking a break this year...">';
